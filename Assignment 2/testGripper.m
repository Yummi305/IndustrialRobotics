...
robot = SerialLink([L1 L2 L3],'name','TestFingerBot1');
        ...
        case 3
            ...
            L1 = Link('d',0.333,'a',0,'alpha',0,'offset',0,'qlim', [-pi, pi]);
            L2 = Link('d',0,'a',0,'alpha',-pi/2,'offset',0,'qlim', [-pi, pi]);
            L3 = Link('d',0,'a',0,'alpha',pi/2,'offset',-pi/2,'qlim', [-pi, pi]);
            L4 = Link('d',0,'a',0.088,'alpha',pi/2,'offset',pi/2,'qlim', [-pi, pi]);
            L5 = Link('d',0.384,'a',-0.088,'alpha',-pi/2,'offset',0,'qlim', [-pi, pi]);% pos or neg dz?
            L6 = Link('d',0,'a',0,'alpha',-pi/2,'offset',pi/2,'qlim', [-pi, pi]);
            L7 = Link('d',0,'a',0.088,'alpha',-pi/2,'offset',-pi/2,'qlim', [-pi, pi]);
            L8 = Link('d',0.1,'a',0,'alpha',0,'offset',0,'qlim', [-pi, pi]);
